...
<body>
	...
	<div class="container">
		<h2 style="text-align: center; margin-top: 30px;">academic 게시판</h2>
		<p style="text-align: center;">YW university</p>
		<div align="right">
		<form id ="searchfrom" action="academicList" method ="get">
		<select name = "type">
		...
		<table class="table">
			...
			<tbody>
				...
				<c:forEach var="board" items="${list }">
					<tr>
						<td>${board.writeNo }</td>
						<td><a href="academicContentView?writeNo=${board.writeNo}">${board.title }</a></td>
						<td>${board.name }</td>
	...
	<form id = "academicform" action ="academicList"  method = "get">
	<input type ="hidden" name = "pageNum" value = "${boardPage.vN.pageNum }">
	<input type ="hidden" name = "amount" value = "${boardPage.vN.amount }">
	</form>
<script type="text/javascript">
	$(document).ready(function() {
		var actionform =$("#academicform");
