	...
	<div style="height: 750px; display: flex;">
		<div
			...
			<table>
				...
				<tr>
					<th style="padding-top: 30px;">${login }</th>
				</tr>
				<tr>
				...
				<div class="container">
					<table class="table">
						<thead class="thead-dark">
							<tr>
								<th>공지사항</th>
								<th style="text-align: right;"><a href="list">more</a></th>
							</tr>
						</thead>
						<tbody>
			...
			<div style="width: 90%; display: flex; margin: auto;">
				<div class="container">
					<table class="table">
						<thead class="thead-dark">
							<tr>
								<th>academicMainList</th>
								<th style="text-align: right;"><a href="academicList">more</a></th>
							</tr>
						</thead>
						<tbody>
